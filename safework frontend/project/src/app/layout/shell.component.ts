...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Hazard Reports', icon: '⚠', route: '/hazards', roles: ['Hazard Officer', 'Manager', 'Administrator', 'Compliance Officer', 'Government Auditor'] },
  { label: 'Incidents', icon: '🔔', route: '/incidents', roles: ['Safety Officer', 'Hazard Officer', 'Manager', 'Administrator', 'Compliance Officer'] },
  { label: 'Inspections', icon: '🔍', route: '/inspections', roles: ['Safety Officer', 'Manager', 'Administrator', 'Compliance Officer', 'Government Auditor'] },
  { label: 'Compliance Checks', icon: '✓', route: '/compliance-checks', roles: ['Safety Officer', 'Administrator', 'Government Auditor'] },
  { label: 'Programs', icon: '📋', route: '/programs', roles: ['Manager', 'Administrator', 'Government Auditor','Compliance Officer'] },
  { label: 'My Training', icon: '🎓', route: '/trainings', roles: ['Employee'] },
  { label: 'Trainings', icon: '🎓', route: '/trainings', roles: ['Manager', 'Administrator', 'Safety Officer','Compliance Officer'] },
  ...
  { label: 'Reports', icon: '📈', route: '/reports', roles: ['Manager', 'Government Auditor'] },
